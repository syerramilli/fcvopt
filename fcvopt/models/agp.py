...
class AGP(GP):
    ...
    def __init__(self,kernel,lower,upper,n_hypers=30,
        ...
        # inherits __init__, predict, log_posterior, 
        # _initialize_kernel_ls, get_incumbent from GP
    ...
    def log_likelihood(self,theta):
        ...
        try:
            Sigma_n_inv,ldet_K = kernel_inv(k1_,self.X,self.eps,True)
    ...
    def _fit_gp(self,theta):
        ...
        # of actual query points
        try:
            Sigma_n_inv = kernel_inv(k1_,self.X,self.eps,False)
        except np.linalg.LinAlgError:
            return -np.inf
